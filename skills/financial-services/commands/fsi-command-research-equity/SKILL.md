---
name: fsi-command-research-equity
description: Use when financial-services work requires generate a comprehensive equity
  research snapshot with consensus estimates, fundamentals, and price performance.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
...
# FSI Command: /research-equity

## Overview
This is the Hermes profile equivalent of the original Cowork slash command `/research-equity` from `lseg`. Invoke it explicitly with `/skill fsi-command-research-equity` or ask in natural language for this workflow.

## When to Use
- Use when the user asks for `/research-equity` or a research equity financial-services workflow.
...
## Hermes Invocation
- Explicit: `/skill fsi-command-research-equity`
- Natural language: “Use the research-equity command workflow for ...”
