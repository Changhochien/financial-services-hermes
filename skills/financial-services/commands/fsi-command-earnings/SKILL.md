---
name: fsi-command-earnings
description: Use when financial-services work requires analyze quarterly earnings
  and create an earnings update report.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
