---
name: fsi-command-review-fi-portfolio
description: Use when financial-services work requires review a fixed income portfolio
  with pricing, reference data, cashflows, and scenario analysis.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
...
## Overview
This is the Hermes profile equivalent of the original Cowork slash command `/review-fi-portfolio` from `lseg`. Invoke it explicitly with `/skill fsi-command-review-fi-portfolio` or ask in natural language for this workflow.

## When to Use
- Use when the user asks for `/review-fi-portfolio` or a review fi portfolio financial-services workflow.
...
## Hermes Invocation
- Explicit: `/skill fsi-command-review-fi-portfolio`
- Natural language: “Use the review-fi-portfolio command workflow for ...”
