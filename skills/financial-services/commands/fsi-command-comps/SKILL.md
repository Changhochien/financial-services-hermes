---
name: fsi-command-comps
description: Use when financial-services work requires build a comparable company
  analysis with trading multiples.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
...
## Overview
This is the Hermes profile equivalent of the original Cowork slash command `/comps` from `financial-analysis`. Invoke it explicitly with `/skill fsi-command-comps` or ask in natural language for this workflow.

## When to Use
- Use when the user asks for `/comps` or a comps financial-services workflow.
...
## Hermes Invocation
- Explicit: `/skill fsi-command-comps`
- Natural language: “Use the comps command workflow for ...”
