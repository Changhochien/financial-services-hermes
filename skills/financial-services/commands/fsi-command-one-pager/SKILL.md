...
description: Use when financial-services work requires create a one-page company strip
  profile using branded PPT template.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
...
## When to Use
- Use when the user asks for `/one-pager` or a one pager financial-services workflow.
...
## Hermes Invocation
- Explicit: `/skill fsi-command-one-pager`
