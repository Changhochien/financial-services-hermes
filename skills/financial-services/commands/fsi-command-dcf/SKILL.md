---
name: fsi-command-dcf
description: Use when financial-services work requires build a DCF valuation model
  with comps-informed terminal multiples.
version: 0.1.0
author: Changhochien
license: MIT
platforms:
...
## Overview
This is the Hermes profile equivalent of the original Cowork slash command `/dcf` from `financial-analysis`. Invoke it explicitly with `/skill fsi-command-dcf` or ask in natural language for this workflow.

## When to Use
- Use when the user asks for `/dcf` or a dcf financial-services workflow.
...
## Hermes Invocation
- Explicit: `/skill fsi-command-dcf`
- Natural language: “Use the dcf command workflow for ...”
