...
description: Use when financial-services work requires produces sector or thematic
  market research — industry overview, competitive landscape, trading-comps spread
  of the peer set, and a thematic ideas shortlist — packaged as a research note with
  optional slides. Use when an analyst or PM asks for a primer on a sector or theme;
...
## When to Use
- Use when the user asks for the `market-researcher` named-agent workflow or an equivalent end-to-end financial-services task.
